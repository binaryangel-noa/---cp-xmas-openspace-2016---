...
namespace EfInjectors.DAL
{
    public class TenantCommandTreeInterceptor : IDbCommandTreeInterceptor
    {
        ...
        /// </summary>
        private static bool InterceptUpdate(DbCommandTreeInterceptionContext interceptionContext, int userId)
        {
            ...
            if (updateCommand != null)
            {
                ...
                if (!string.IsNullOrEmpty(column))
                {
                    ...
                    var tenantIdWherePredicate = DbExpressionBuilder.Equal(tenantProperty, DbExpression.FromInt32(userId));
        ...
        /// </summary>
        private static void InterceptDeleteCommand(DbCommandTreeInterceptionContext interceptionContext, int userId)
        {
